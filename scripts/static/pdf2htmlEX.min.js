...
*/
  ...
  Page.prototype = {
    ...
    rescale: function (a) {
      if (a === 0) {
        const containerWidth = this.page.parentNode.clientWidth;
        this.cur_scale = containerWidth / this.original_width;
      } else {
        this.cur_scale = a;
      }
  ...
  Viewer.prototype = {
    ...
    initialize_radio_button: function () {
      for (
        var a = document.getElementsByClassName(CSS_CLASS_NAMES.input_radio),
          b = 0;
        b < a.length;
        b++
      )
    ...
    find_pages: function () {
      for (
        var a = [], b = {}, c = this.container.childNodes, e = 0, h = c.length;
        e < h;
        ++e
      ) {
        var d = c[e];
    ...
    fit_width: function () {
      ...
      console.log(this.container.clientWidth / this.pages[a].width(), !0);
      this.rescale(this.container.clientWidth / this.pages[a].width(), !0);
      this.scroll_to(a);
    },
    fit_height: function () {
      var a = this.cur_page_idx;
      console.log(this.container.clientHeight / this.pages[a].height(), !0);
