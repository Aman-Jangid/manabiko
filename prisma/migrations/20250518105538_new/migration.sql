...
-- CreateIndex
CREATE UNIQUE INDEX "UserBook_userId_documentId_key" ON "UserBook"("userId", "documentId");
...
-- AddForeignKey
ALTER TABLE "UserBook" ADD CONSTRAINT "UserBook_documentId_fkey" FOREIGN KEY ("documentId") REFERENCES "Document"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
