...
export default function LibraryArea() {
    ...
    () => [
      {
        ...
        coverImage: "/book_covers/book_of_art.png",
        lastRead: "4:58 PM 25 April 2024",
      ...
      },
      {
        ...
        coverImage: "/book_covers/killer_poison.png",
        lastRead: "7:58 PM 27 April 2024",
        progress: randomProgress(),
      },
      {
        id: "3",
        ...
        author: "A.Y. Bhargava",
        coverImage: "/book_covers/grokking_algorithms.png",
        lastRead: "7:58 PM 27 April 2024",
        progress: randomProgress(),
      },
      {
        ...
        coverImage: "/book_covers/c_programming.png",
        lastRead: "",
        progress: 0,
      },
      {
        ...
        coverImage: "/book_covers/eloquent_javascript.png",
        lastRead: "",
        progress: 0,
      },
      {
        ...
        coverImage: "/book_covers/processing.png",
        lastRead: "",
        progress: 0,
      },
      {
        ...
        coverImage: "/book_covers/clean_code.png",
        lastRead: "",
        progress: randomProgress(),
      },
      {
        ...
        author: "Don Norman",
        coverImage: "/book_covers/design_everyday_things.png",
        lastRead: "",
        progress: randomProgress(),
      },
      {
        ...
        coverImage: "/book_covers/deep_learning.png",
        lastRead: "",
        progress: 0,
      },
      {
        ...
        coverImage: "/book_covers/pragmatic_programmer.png",
        lastRead: "",
        progress: randomProgress(),
      },
    ],
  ...
  const renderBook = (book: Book) => (
    <div key={book.id} className="flex flex-col">
      ...
      <h3 className="text-sm sm:text-base md:text-lg font-medium truncate mb-1">
        {book.title}
      </h3>
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 md:p-8 text-white">
      <header className="flex flex-col sm:flex-row sm:items-center sm:place-content-between gap-5 sm:gap-6 mb-8 sm:mb-10">
        <h1 className="text-6xl sm:text-6xl md:text-6xl lg:text-7xl font-light text-center sm:text-left sm:mb-0 mb-4 -mt-4 sm:mt-0">
          Your Books
        </h1>
        <div className="flex flex-row gap-3">
          <button
            className="bg-transparent border border-gray-800 rounded-lg p-2.5 hover:bg-gray-800 transition-colors flex items-center justify-center"
            aria-label="Add book"
          >
            <PlusCircle size={20} />
          </button>
          <div className="relative flex-grow">
            ...
            <input
              type="text"
              className="w-full bg-transparent border border-gray-800 rounded-lg pl-10 pr-4 py-2.5 focus:outline-none focus:ring-1 focus:ring-gray-700"
      ...
      <div className="relative h-[70vh]">
        ...
        <div className="absolute right-0 top-0 bottom-0 w-1 sm:w-1.5 bg-gray-800 rounded-full flex items-center">
          <div
            className="absolute w-full bg-blue-500 rounded-full transition-all duration-150 ease-out"
            style={{
